...
import de.se.common.blocks.machine.repairer.BlockRepairer;
...
public class SEBlocks {
	...
	private static final List<Block> STARPANELS = Lists.newArrayList();
	...
	public static Block MACHINE_FRAME, REPAIRER;
	...
	public static void init() {
		...
		REPAIRER = new BlockRepairer(Names.blockFluxRepairer);
	...
	public static List<Block> getStarPanels()
	{
		return STARPANELS;
	}
