...
public class TileMediumCapacitor extends TileSmallCapacitor{
	
	@Override
	public int getMaxStorage() {
		return ConfigValues.mediumSFCapacitorCapacity;
	}
	
	@Override
	public int getMaxReceive() {
		return ConfigValues.mediumSFCapacitorIn;
	}
	
	@Override
	public int getMaxExtract() {
		return ConfigValues.mediumSFCapacitorOut;
	}
