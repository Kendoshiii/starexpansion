package de.se.common.container.repairer;

import de.se.common.tiles.repairer.TileRepairer;
import de.se.common.utils.helper.StackHelper;
...
public class ContainerRepairer extends Container {
	...
	private TileRepairer tile;
	private static final EntityEquipmentSlot[] VALID_EQUIPMENT_SLOTS = new EntityEquipmentSlot[] {EntityEquipmentSlot.HEAD, EntityEquipmentSlot.CHEST, EntityEquipmentSlot.LEGS, EntityEquipmentSlot.FEET};

	public ContainerRepairer(final InventoryPlayer inventoryplayer, TileRepairer t) {
		this.tile = t;
