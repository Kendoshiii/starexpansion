...
public class SERecipes {
	...
	private static void normalCrafting(){
		...
		GameRegistry.addRecipe(new ItemStack(SEBlocks.MACHINE_FRAME), "GIG", "L L", "GIG", 'G', Items.GOLD_INGOT, 'I', Blocks.IRON_BARS, 'L', new ItemStack(Items.DYE, 1, 4));
		/*
		GameRegistry.addRecipe(new ItemStack(SEBlocks.FURNACE_GENERATOR), "XXX", "XFX", "IRI", 'X', Blocks.COBBLESTONE, 'F', SEBlocks.MACHINE_FRAME, 'I', Items.IRON_INGOT, 'R', Items.REDSTONE);
		GameRegistry.addRecipe(new ItemStack(SEBlocks.NETHERSTAR_GENERATOR), "GIG", "IFI", "RIR", 'G', Items.GOLD_INGOT, 'F', SEBlocks.FURNACE_GENERATOR, 'I', Items.NETHER_STAR, 'R', Items.REDSTONE);
		GameRegistry.addRecipe(new ItemStack(SEBlocks.STARFLUX_GENERATOR), "EIE", "IFI", "RIR", 'E', Items.EMERALD, 'F', SEBlocks.NETHERSTAR_GENERATOR, 'I', new ItemStack(SEItems.INGOT, 1, ItemIngot.INGOT_RADIANT_STAR), 'R', Items.REDSTONE);
